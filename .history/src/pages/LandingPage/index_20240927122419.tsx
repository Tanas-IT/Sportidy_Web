          ...
          <Flex align="center" justify="flex-start">
            ...
            <Box textAlign="left" marginLeft="6rem" marginBottom="5rem">
              ...
              <Text fontSize="xl" color="gray.600" lineHeight="tall">
                <strong>SPORTIDY</strong> is the ultimate platform for sports fans to connect,
                collaborate, and celebrate their passion for athletics. Whether you're looking to
                find a pickup game, organize a watch party, or just chat with fellow enthusiasts,
                <strong>SPORTIDY</strong> makes it easy to build your sports tribe.
              </Text>
            </Box>
          </Flex>
        </Box>
